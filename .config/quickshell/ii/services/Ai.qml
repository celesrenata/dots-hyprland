...
Singleton {
    ...
    Process {
        ...
        function makeRequest() {
            ...
            const data = root.currentApiStrategy.buildRequestData(model, filteredMessageArray, root.systemPrompt, tuning.temperature, root.tools[model.api_format][root.currentTool], tuning);
